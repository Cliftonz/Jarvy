...
description: "Every tool Jarvy knows how to install — 236 entries spanning runtimes, build tools, cloud SDKs, container tools, security scanners, and editors."
tags:
  - reference
  - tools
---
...
Jarvy currently ships **236 tools**. Reference one in your `jarvy.toml` by its **name**.
...
| `arctl` | `arctl` | — | — | — |  | — |
| `argo` | `argo` | `brew: argo` | — | — |  | — |
| `argocd` | `argocd` | `brew: argocd` | apk: `argocd` | `winget: Argoproj.ArgoCD` |  | — |
...
| `betterleaks` | `betterleaks` | `brew: betterleaks` | — | — |  | — |
...
| `dagger` | `dagger` | `brew: dagger/tap/dagger` | apt: `dagger`<br>dnf: `dagger`<br>pacman: `dagger`<br>apk: `dagger` | `winget: Dagger.Dagger` |  | — |
| `dapr` | `dapr` | `brew: dapr/tap/dapr-cli` | apt: `dapr`<br>dnf: `dapr`<br>pacman: `dapr`<br>apk: `dapr` | `winget: Dapr.CLI` |  | — |
...
| `delve` | `dlv` | `brew: delve` | apt: `delve`<br>dnf: `delve`<br>pacman: `delve`<br>apk: `delve` | `winget: Go.Delve` |  | — |
...
| `earthly` | `earthly` | `brew: earthly/earthly/earthly` | apt: `earthly`<br>dnf: `earthly`<br>pacman: `earthly`<br>apk: `earthly` | `winget: Earthly.Earthly` |  | — |
| `eksctl` | `eksctl` | `brew: eksctl` | apt: `eksctl`<br>dnf: `eksctl`<br>pacman: `eksctl`<br>apk: `eksctl` | `winget: weaveworks.eksctl` |  | — |
| `elixir` | `elixir` | `brew: elixir` | apt: `elixir`<br>dnf: `elixir`<br>pacman: `elixir`<br>apk: `elixir` | `winget: Elixir.Elixir` |  | — |
...
| `git_secrets` | `git-secrets` | `brew: git-secrets` | apt: `git-secrets`<br>dnf: `git-secrets`<br>pacman: `git-secrets`<br>apk: `git-secrets` | — |  | — |
| `gitleaks` | `gitleaks` | `brew: gitleaks` | — | `winget: Gitleaks.Gitleaks` |  | — |
| `gitversion` | `gitversion` | `brew: gitversion` | apt: `gitversion`<br>dnf: `gitversion`<br>pacman: `gitversion`<br>apk: `gitversion` | `winget: GitTools.GitVersion` |  | — |
...
| `gofumpt` | `gofumpt` | `brew: gofumpt` | apt: `gofumpt`<br>dnf: `gofumpt`<br>pacman: `gofumpt`<br>apk: `gofumpt` | `winget: mvdan.gofumpt` |  | — |
| `golangci_lint` | `golangci-lint` | `brew: golangci-lint` | apt: `golangci-lint`<br>dnf: `golangci-lint`<br>pacman: `golangci-lint`<br>apk: `golangci-lint` | `winget: GolangCI.golangci-lint` |  | — |
| `gopls` | `gopls` | `brew: gopls` | apt: `gopls`<br>dnf: `gopls`<br>pacman: `gopls`<br>apk: `gopls` | `winget: Google.Gopls` |  | — |
| `goreleaser` | `goreleaser` | `brew: goreleaser` | apt: `goreleaser`<br>dnf: `goreleaser`<br>pacman: `goreleaser`<br>apk: `goreleaser` | `winget: GoReleaser.GoReleaser` |  | — |
| `gotestsum` | `gotestsum` | `brew: gotestsum` | apt: `gotestsum`<br>dnf: `gotestsum`<br>pacman: `gotestsum`<br>apk: `gotestsum` | `winget: gotestyourself.gotestsum` |  | — |
| `govulncheck` | `govulncheck` | `brew: govulncheck` | apt: `govulncheck`<br>dnf: `govulncheck`<br>pacman: `govulncheck`<br>apk: `govulncheck` | — |  | — |
...
| `helm` | `helm` | `brew: helm` | apt: `helm`<br>dnf: `helm`<br>pacman: `helm`<br>apk: `helm` | `winget: Helm.Helm` |  | — |
...
| `k3d` | `k3d` | `brew: k3d` | — | `winget: k3d-io.k3d` |  | — |
| `k6` | `k6` | `brew: k6` | apt: `k6`<br>dnf: `k6`<br>pacman: `k6`<br>apk: `k6` | `winget: Grafana.k6` |  | — |
| `k9s` | `k9s` | `brew: derailed/k9s/k9s` | apt: `k9s`<br>dnf: `k9s`<br>pacman: `k9s`<br>apk: `k9s` | `winget: Derailed.k9s` |  | — |
| `kaf` | `kaf` | `brew: kaf` | — | — |  | — |
| `kafka` | `kafka-topics` | `brew: kafka` | — | — |  | — |
| `kafkactl` | `kafkactl` | `brew: deviceinsight/packages/kafkactl` | — | — |  | — |
| `kagent` | `kagent` | `brew: kagent` | — | — |  | — |
| `kcat` | `kcat` | `brew: kcat` | apt: `kafkacat`<br>dnf: `kcat`<br>pacman: `kcat`<br>apk: `kcat` | — |  | — |
| `kind` | `kind` | `brew: kind` | — | `winget: Kubernetes.kind` |  | — |
| `kmcp` | `kmcp` | — | — | — |  | — |
| `kn` | `kn` | `brew: kn` | — | — |  | — |
| `ko` | `ko` | `brew: ko` | apt: `ko`<br>dnf: `ko`<br>pacman: `ko`<br>apk: `ko` | `winget: ko-build.ko` |  | — |
| `kotlin` | `kotlin` | `brew: kotlin` | apt: `kotlin`<br>dnf: `kotlin`<br>pacman: `kotlin`<br>apk: `kotlin` | `winget: JetBrains.Kotlin.Compiler`<br>`choco: kotlinc` |  | — |
| `krew` | `kubectl-krew` | `brew: krew` | apk: `kubectl-krew` | — |  | — |
| `kubectl` | `kubectl` | `brew: kubectl` | apt: `kubectl`<br>dnf: `kubectl`<br>pacman: `kubectl`<br>apk: `kubectl` | `winget: Kubernetes.kubectl` |  | — |
| `kubectx` | `kubectx` | `brew: kubectx` | — | `winget: ahmetb.kubectx` |  | — |
| `kubens` | `kubens` | `brew: kubectx` | — | — |  | — |
| `kubescape` | `kubescape` | `brew: kubescape` | apt: `kubescape`<br>dnf: `kubescape`<br>pacman: `kubescape`<br>apk: `kubescape` | `winget: kubescape.kubescape` |  | — |
...
| `lazydocker` | `lazydocker` | `brew: lazydocker` | apk: `lazydocker` | `choco: lazydocker` |  | — |
...
| `localstack` | `localstack` | `brew: localstack` | apt: `localstack`<br>dnf: `localstack`<br>pacman: `localstack`<br>apk: `localstack` | — |  | — |
...
| `luarocks` | `luarocks` | `brew: luarocks` | apt: `luarocks`<br>dnf: `luarocks`<br>pacman: `luarocks`<br>apk: `luarocks` | `winget: LuaRocks.LuaRocks` |  | — |
...
| `minikube` | `minikube` | `brew: minikube` | apt: `minikube`<br>dnf: `minikube`<br>pacman: `minikube`<br>apk: `minikube` | `winget: Kubernetes.minikube` |  | — |
| `mise` | `mise` | `brew: mise` | — | `winget: jdx.mise` |  | — |
| `mockgen` | `mockgen` | `brew: mockery` | apt: `mockery`<br>dnf: `mockery`<br>pacman: `mockery`<br>apk: `mockery` | `winget: vektra.mockery` |  | — |
| `molecule` | `molecule` | `brew: molecule` | apt: `molecule`<br>dnf: `molecule`<br>pacman: `molecule`<br>apk: `molecule` | — |  | — |
...
| `rust` | `rustc` | — | — | — |  | — |
| `scala` | `scala` | `brew: scala` | apt: `scala`<br>dnf: `scala`<br>pacman: `scala`<br>apk: `scala` | `winget: Scala.Scala.3`<br>`choco: scala` |  | — |
...
| `stern` | `stern` | `brew: stern` | apt: `stern`<br>dnf: `stern`<br>pacman: `stern`<br>apk: `stern` | `winget: stern.stern` |  | — |
| `syft` | `syft` | `brew: syft` | apk: `syft` | `choco: syft` |  | — |
| `tailscale` | `tailscale` | `brew: tailscale` | — | `winget: Tailscale.Tailscale` |  | — |
| `talisman` | `talisman` | `brew: talisman` | — | — |  | — |
